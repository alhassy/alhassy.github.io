...
(cl-loop for file in (f-files "~/blog/posts")
         ...
         ;; (f-write-text  (pp-to-string posts) 'utf-8 (f-expand "~/blog/posts.el"))
...
(setq posts (with-temp-buffer (insert-file-contents "~/blog/posts.json") (json-parse-buffer)))
...
(defun @tags (json) (s-split " " (map-elt json "tags")))
