...
(setq blog/posts (with-temp-buffer (insert-file-contents "~/blog/posts.json") (json-parse-buffer)))
...
;; (defun @image (json) (map-elt json "image"))
...
;; TODO: Axe `blog/tags-of-file' since it's now subsumed by this method.
(defun @tags (json)
...
;; Core helper to get the plist/JSON metadata about each post.
    ...
    (insert
     (s-join
      ...
      (list
       ...
       "#+begin_export html"
       org-static-blog-page-preamble
       (setq org-static-blog-page-header "") ;; TODO: Just use the var, don't zero it out. For now, it's super huge, like org-html-head-extra; not sure why.
       "#+end_export"
