...
;; TODO: Axe `blog/tags-of-file' since it's now subsumed by the method: (defun @tags (json)


;; TODO: Axe `blog/history-of-file' since its subsumed by this method now
(defun @history (json)


;; TODO: Axe `my/org-static-blog-assemble-image' since it's now subsumed by this method.
...
#+begin_src emacs-lisp :tangle no :results replace value :wrap src js :exports results
...
* COMMENT /Seamlessly/ Previewing Articles /within/ Emacs 😲
:PROPERTIES:
...
words
#+end_abstract
* COMMENT /Style/! ✨ What do we want to be inserted into the head of every page?
  :PROPERTIES:
...
* COMMENT Ξ: Floating /Table of Contents/
  :PROPERTIES:
...
* COMMENT Org Marco: “This section has been #+include'd from my init.org” :ignore:
:PROPERTIES:
...
* COMMENT Curvy Source Blocks & Pink Inline
  :PROPERTIES:
...
* COMMENT Blog Banner and Dynamic Code Highlighting
  :PROPERTIES:
...
* COMMENT MathJax Support --- $e^{i \cdot \pi} + 1 = 0$
  :PROPERTIES:
...
[[https://github.com/alhassy/emacs.d#what-does-literate-programming-look-like][noweb-ref]] named =my-html-header= to refer to them, which are then catenated below.
:end:
* COMMENT Using [[https://github.com/bastibe/org-static-blog][org-static-block]]
  :PROPERTIES:
...
(setq org-static-blog-publish-url "https://alhassy.com")
...
#+begin_src emacs-lisp -n
;; Overriding org-static-blog's method.
    ...
    (insert
     (s-join
      ...
      (list
       ...
       (concat "#+title: " org-static-blog-publish-title)
       "#+begin_export html"
