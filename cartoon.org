...
#+begin_src js :var SHOWS=(if (file-exists-p "shows.json") (f-read-text "shows.json") "[]") :wrap export html :exports none :eval never-export
console.log(`
